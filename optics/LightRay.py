...
class LightRay(Ray):
    ...
    def __init__(self, a, b, start_point: Point2D):
        """
        ...
        # Stores the points of intersection with other objects
        self.refractionPoints = []
    ...
    def getRayAtPointWithAngle(point, angle):
        ...
        return LightRay(straight.a, straight.b, point)
